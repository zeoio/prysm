...
import (
	...
	ethpbalpha "github.com/prysmaticlabs/ethereumapis/eth/v1alpha1"
...
// GetGenesis - placeholder for interface.
func (ns *Server) GetGenesis(ctx context.Context, _ *ptypes.Empty) (*ethpbalpha.Genesis, error) {
	return nil, errors.New("Unimplemented")
}

// GetImplementedServices - placeholder for interface.
func (ns *Server) GetImplementedServices(ctx context.Context, _ *ptypes.Empty) (*ethpbalpha.ImplementedServices, error) {
	return nil, errors.New("Unimplemented")
}
...
func (ns *Server) GetHealth(ctx context.Context, _ *ptypes.Empty) (*ptypes.Empty, error) {
	return nil, status.Errorf(codes.Internal, "Unable to get health")
}
