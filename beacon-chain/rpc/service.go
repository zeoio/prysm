...
func (s *Service) Start() {
	...
	ethpb_service.RegisterBeaconNodeServer(s.grpcServer, nodeServerV1)
	...
	ethpb_service.RegisterBeaconChainServer(s.grpcServer, beaconChainServerV1)
	ethpb_service.RegisterEventsServer(s.grpcServer, &events.Server{
		Ctx:               s.ctx,
		StateNotifier:     s.cfg.StateNotifier,
		BlockNotifier:     s.cfg.BlockNotifier,
		OperationNotifier: s.cfg.OperationNotifier,
	...
	if s.cfg.EnableDebugRPCEndpoints {
		...
		ethpb_service.RegisterBeaconDebugServer(s.grpcServer, debugServerV1)
	}
	ethpbv1alpha1.RegisterBeaconNodeValidatorServer(s.grpcServer, validatorServer)
	ethpb_service.RegisterBeaconValidatorServer(s.grpcServer, validatorServerV1)
