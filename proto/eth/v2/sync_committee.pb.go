...
type SubmitSyncCommitteeSignaturesRequest struct {
	...
	Data []*SyncCommitteeMessageV2 `protobuf:"bytes,1,rep,name=data,proto3" json:"data,omitempty"`
}
...
func (x *SubmitSyncCommitteeSignaturesRequest) GetData() []*SyncCommitteeMessageV2 {
	if x != nil {
		return x.Data
	}
	return nil
...
type SyncCommitteeMessageV2 struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SyncCommitteeMessageV2) Reset() {
	*x = SyncCommitteeMessageV2{}
	if protoimpl.UnsafeEnabled {
...
func (x *SyncCommitteeMessageV2) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SyncCommitteeMessageV2) ProtoMessage() {}

func (x *SyncCommitteeMessageV2) ProtoReflect() protoreflect.Message {
	mi := &file_proto_eth_v2_sync_committee_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SyncCommitteeMessageV2.ProtoReflect.Descriptor instead.
func (*SyncCommitteeMessageV2) Descriptor() ([]byte, []int) {
	return file_proto_eth_v2_sync_committee_proto_rawDescGZIP(), []int{1}
}

func (x *SyncCommitteeMessageV2) GetSlot() github_com_prysmaticlabs_eth2_types.Slot {
	if x != nil {
		return x.Slot
	}
...
func (x *SyncCommitteeMessageV2) GetBeaconBlockRoot() []byte {
	if x != nil {
...
func (x *SyncCommitteeMessageV2) GetValidatorIndex() github_com_prysmaticlabs_eth2_types.ValidatorIndex {
	if x != nil {
...
func (x *SyncCommitteeMessageV2) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
type StateSyncCommitteesResponse struct {
	...
	Data *SyncCommitteeV2 `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
}
...
func (x *StateSyncCommitteesResponse) GetData() *SyncCommitteeV2 {
	if x != nil {
		return x.Data
	}
	return nil
...
type SyncCommitteeV2 struct {
	...
	Validators          []github_com_prysmaticlabs_eth2_types.ValidatorIndex `protobuf:"varint,1,rep,packed,name=validators,proto3" json:"validators,omitempty" cast-type:"github.com/prysmaticlabs/eth2-types.ValidatorIndex" ssz-size:"512"`
...
func (x *SyncCommitteeV2) GetValidators() []github_com_prysmaticlabs_eth2_types.ValidatorIndex {
	if x != nil {
		return x.Validators
	}
...
func (x *SyncCommitteeV2) GetValidatorAggregates() []*SyncSubcommittee {
	if x != nil {
...
type SyncSubcommittee struct {
	...
	Validators []github_com_prysmaticlabs_eth2_types.ValidatorIndex `protobuf:"varint,1,rep,packed,name=validators,proto3" json:"validators,omitempty" cast-type:"github.com/prysmaticlabs/eth2-types.ValidatorIndex" ssz-max:"512"`
}
...
var file_proto_eth_v2_sync_committee_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x63, 0x0a, 0x24, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x53, 0x79, 0x6e, 0x63, 0x43,
	...
	0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x95, 0x02, 0x0a, 0x16, 0x53, 0x79, 0x6e, 0x63, 0x43,
	0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x56,
	...
	0x02, 0x39, 0x36, 0x52, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x8b,
	...
	0x07, 0x73, 0x74, 0x61, 0x74, 0x65, 0x49, 0x64, 0x12, 0x48, 0x0a, 0x05, 0x65, 0x70, 0x6f, 0x63,
	...
	0x01, 0x01, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x22, 0x53, 0x0a, 0x1b,
	0x53, 0x74, 0x61, 0x74, 0x65, 0x53, 0x79, 0x6e, 0x63, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x74,
	0x65, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x34, 0x0a, 0x04, 0x64,
	...
	,
	...
	0x68, 0x2e, 0x76, 0x32, 0x2e, 0x53, 0x79, 0x6e, 0x63, 0x53, 0x75, 0x62, 0x63, 0x6f, 0x6d, 0x6d,
	0x69, 0x74, 0x74, 0x65, 0x65, 0x52, 0x13, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72,
	0x41, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x73, 0x22, 0x71, 0x0a, 0x10, 0x53, 0x79,
	0x6e, 0x63, 0x53, 0x75, 0x62, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x65, 0x12, 0x5d,
	0x0a, 0x0a, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x04, 0x42, 0x3d, 0x92, 0xb5, 0x18, 0x03, 0x35, 0x31, 0x32, 0x82, 0xb5, 0x18, 0x32, 0x67,
...
var file_proto_eth_v2_sync_committee_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_proto_eth_v2_sync_committee_proto_goTypes = []interface{}{
	...
	(*SyncCommitteeMessageV2)(nil),               // 1: ethereum.eth.v2.SyncCommitteeMessageV2
	...
	(*SyncCommitteeV2)(nil),                      // 4: ethereum.eth.v2.SyncCommitteeV2
	(*SyncSubcommittee)(nil),                     // 5: ethereum.eth.v2.SyncSubcommittee
}
var file_proto_eth_v2_sync_committee_proto_depIdxs = []int32{
	1, // 0: ethereum.eth.v2.SubmitSyncCommitteeSignaturesRequest.data:type_name -> ethereum.eth.v2.SyncCommitteeMessageV2
	4, // 1: ethereum.eth.v2.StateSyncCommitteesResponse.data:type_name -> ethereum.eth.v2.SyncCommitteeV2
	5, // 2: ethereum.eth.v2.SyncCommitteeV2.validator_aggregates:type_name -> ethereum.eth.v2.SyncSubcommittee
...
func file_proto_eth_v2_sync_committee_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_eth_v2_sync_committee_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SyncCommitteeMessageV2); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_proto_eth_v2_sync_committee_proto_msgTypes[2].OneofWrappers = []interface{}{}
	type x struct{}
